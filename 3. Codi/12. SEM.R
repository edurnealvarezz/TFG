...
sink("4. Outputs/12.1 Output_text_sem.txt")
pdf("4. Outputs/12.2 Output_grafics_sem.pdf", width = 12, height = 9)
...
if (!is.null(fit_cfa)) {
  ...
  summary(fit_cfa, fit.measures = TRUE, standardized = TRUE) # resum model
